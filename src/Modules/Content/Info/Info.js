                ...
                <Tabs type="card" >
                    <TabPane tab="Биография"  key="1">
                        ...
                        <h2>
                            ...
                            <p>Примерно в 14 лет администрировал игровой сервер, и появилась нужда в информационном сайте, приобщенному к серверу.</p>
                            ...
                            <p></p>
                            <p style={{fontSize: "22px", font: "bold"}}>Институт:</p>
                            <p>После, из-за стремления к изучению нового, </p>
                            <p>начал изучать C# для себя,  с которым и довелось поработать дальше в институте. </p>
                            <p>На практике познакомлся с технологией MVC Asp.Net, и начал разбираться с Web-программированием более углубленно.</p>
                            <p></p>
                            <p>И вот уже более 10 лет, я не теряя интереса, занимаюсь программированием. </p>
                        </h2>
                        </div>
                    </TabPane>
